...
var restHelper = module.exports = {
    ...
    notImplemented: function(arg, roles) {
        lib.sendError(arg.response, 418, 'Not implemented');
        return true;
    },

    checkPermission: function(arg, roles) {
        if(!arg.session || !roles.includes(common.sessions[arg.session].role)) {
    ...
    manageSingleObject: function(arg, collection, aggregation, transformation) {
        switch(arg.method) {
            case 'GET':
                try {
            ...
            case 'PUT':
                try {
                    ...
                    if(transformation) transformation(arg.payload);
    ...
    getObjects: function(arg, collection, aggregation, defaultLimit, searchQuery) {
        switch(arg.method) {
            ...
            case 'GET':
                ...
                if(!aggregation) aggregation = { $skip: 0 }; // empty aggregation
