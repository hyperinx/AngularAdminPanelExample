// common parts
var app = angular.module('app2020', [ 'ngSanitize', 'ngAnimate', 'ngRoute', 'ui.bootstrap', 'infinite-scroll' ]);

// router menu
app.constant('routes', [
	{ route: '/', templateUrl: 'homeView.html', controller: 'HomeCtrl', controllerAs: 'ctrl', menu: '<i class="fa fa-lg fa-home"></i>', roles: [ 0, 1, 2 ] },
	{ route: '/example', templateUrl: 'exampleView.html', controller: 'ExampleCtrl', controllerAs: 'ctrl', menu: 'Przykład', roles: [ 1 ] },
...
// alert controller
app.controller('AlertCtrl', ['common', function(common) {
    var ctrl = this;
...
app.controller('ContainerCtrl', ['$scope', '$http', '$location', '$uibModal', 'routes', 'common', function($scope, $http, $location, $uibModal, routes, common) {
    var ctrl = this;
    ...
    ctrl.loginIcon = function() {
        return common.user.login ? common.user.firstName + ' ' + common.user.lastName + '&nbsp;<span class="fa fa-lg fa-sign-out"></span>' : '<span class="fa fa-lg fa-sign-in"></span>';
    };
